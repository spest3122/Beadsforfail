                ...
                {!currentGoal ? (
                    ...
                    >
                        <div className="text-center mb-8">
                            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-primary to-primary-variant pb-4">
                                What's your next big goal?
                            </h1>
                            <p className="text-on-background/70 text-lg">
                                Set a goal and drop 1,000 beads to achieve it.
                            </p>
                        </div>
